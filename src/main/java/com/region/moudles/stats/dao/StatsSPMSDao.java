...
@Named
public class StatsSPMSDao extends QueryDao {
	 ...
	 * @throws
	 */
	public List<ResultModel> getTQLineData(StatsPlatResultModel info) {
	 ...
	 * @throws
	 */
	public List<ResultModel> getMedicantChartsData(StatsPlatResultModel mode) {
		StringBuffer sql = new StringBuffer();
		sql.append("select * from table(stats_plat_onelevel_other(:startTime, :endTime, :incomeType, :orgCode)) ");
		return queryList(sql.toString(), mode, ResultModel.class);
	 ...
	 * @throws
	 */
	public List<ResultModel> getMedicantTypeByMonth(StatsPlatResultModel mode) {
		StringBuffer sql = new StringBuffer();
	 ...
	 * @throws
	 */
	public List<ResultModel> getMedicantTypeProp(StatsPlatResultModel mode) {
		StringBuffer sql = new StringBuffer();
