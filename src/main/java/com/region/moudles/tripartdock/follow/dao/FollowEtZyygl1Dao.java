...
import com.region.moudles.tripartdock.follow.dao.repository.FollowEtZyygl1Repository;
...
@Named
public class FollowEtZyygl1Dao  extends BaseDao<FollowEtZyygl1Repository,FollowEtZyygl1>{

    public List<EtZy1Dto> getAll(RequestDto request) {
        StringBuilder sql = new StringBuilder();
        sql.append("select * from (select t.*,ROWNUM rn from( ");
        sql.append(" select b.id,b.jmid,b.etbh,b.dah,b.sffl stage,b.sfzh,b.sfrq,jb.hzmc xm,o.id org_id,o.org_name,b.sfys as sfys_name");
        sql.append(" from blt_etzyygl b");
        ...
        List<EtZy1Dto> list = queryList(sql.toString(), request, EtZy1Dto.class);
        return list;
    }

    public int getCount(RequestDto request) {
        StringBuilder sql = new StringBuilder();
        sql.append("select b.id from blt_etzyygl b join blt_jbxxjlb jb on b.jmid = jb.id join sys_org o on o.id = jb.jdjg where ");
    ...
    public int getSFCountByJmId(String jmId) {
        StringBuilder sql = new StringBuilder();
        sql.append("select a.id from blt_etzyygl a ");
