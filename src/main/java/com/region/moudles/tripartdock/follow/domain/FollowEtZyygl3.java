 ...
 */
@Entity
@Table(name = "blt_1_3setzyyglfwjlb")
public class FollowEtZyygl3 extends BaseDomain {
	...
	public String getZyyjkglfwName() {
		if ("1".equals(sflx))
			return DictUtil.getDictValue("etzyy-jkgl1", this.zyyjkglfw);
		return DictUtil.getDictValue("etzyy-jkgl2", this.zyyjkglfw);
	}

	public void setZyyjkglfwName(String zyyjkglfwName) {
		this.zyyjkglfwName = zyyjkglfwName;
	}
