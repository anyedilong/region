...
import com.region.moudles.tripartdock.follow.dao.repository.FollowEtZyygl3Repository;
...
@Named
public class FollowEtZyygl3Dao extends BaseDao<FollowEtZyygl3Repository,FollowEtZyygl3>{

    public List<EtZy3Dto> getAll(RequestDto request) {
        StringBuilder sql = new StringBuilder();
        sql.append("select * from (select t.*,ROWNUM rn from( ");
        sql.append(" select b.id,b.jmid,b.etbh,b.dah,b.sflx stage,b.sfzh,b.sfrq,jb.hzmc xm,o.id org_id,o.org_name,b.sfys as sfys_name");
        sql.append(" from blt_1_3setzyyglfwjlb b");
        ...
        List<EtZy3Dto> list = queryList(sql.toString(), request, EtZy3Dto.class);
        return list;
    }

    public int getCount(RequestDto request) {
        StringBuilder sql = new StringBuilder();
        sql.append("select b.id from blt_1_3setzyyglfwjlb b join blt_jbxxjlb jb on b.jmid = jb.id join sys_org o on o.id = jb.jdjg ");
    ...
    public int getSFCountByJmId(String jmId) {
        StringBuilder sql = new StringBuilder();
        sql.append("select a.id from blt_1_3setzyyglfwjlb a ");
